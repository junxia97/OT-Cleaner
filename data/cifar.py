    ...
    def __getitem__(self, index):
        ...
        if self.train:
            if self.noise_type !='clean':
                img, target, real_target = self.train_data[index], self.train_noisy_labels[index], self.train_labels[index]
            else:
                img, target, real_target = self.train_data[index], self.train_labels[index], self.train_labels[index]
        else:
